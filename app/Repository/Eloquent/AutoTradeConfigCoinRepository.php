...
use App\Repository\Contracts\AutoTradeConfigCoinInterface as AutoTradeConfigCoinInterface;

class AutoTradeConfigCoinRepository extends BaseRepository implements AutoTradeConfigCoinInterface
{
    ...
    {
        return \App\AutoTradeConfigCoin::class;
    }

    public function checkCoinActive($user_id, $coin_id)
    {
    ...
    public function buyOrderExist($user_id, $coin_id){
